...
// legacy_stdio_definitions.lib, which we do using this pragma. Your own project should not be affected, as
// you are likely to link with a newer binary of GLFW that is adequate for your version of Visual Studio.
...
int main(int, char **)
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
            ...
            ImGui::ColorEdit3(
                "clear color", reinterpret_cast<float *>(&clear_color)); // Edit 3 floats representing a color
